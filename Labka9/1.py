...
while not done:
    ...
    if count_of_coins > 50 * cirle: #if count of coins more than 50*n than make enemy faster
        cirle += 2
        speed += 2 #add speed for game
    ...
    if P1.rect.colliderect(C1.rect):
        ...
        count_of_coins += randint(1 , 100) #collect random size of coins and 
        C1.rect.top = -50  
